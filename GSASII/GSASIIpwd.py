...
# $Date: 2023-02-03 12:09:07 -0500 (Fri, 03 Feb 2023) $
# $Author: toby $
# $Revision: 5492 $
# $URL: https://subversion.xray.aps.anl.gov/pyGSAS/trunk/GSASIIpwd.py $
# $Id: GSASIIpwd.py 5492 2023-02-03 17:09:07Z toby $
########### SVN repository information ###################
...
import GSASIIpath
filversion = "$Revision: 5492 $"
GSASIIpath.SetVersionNumber("$Revision: 5492 $")
