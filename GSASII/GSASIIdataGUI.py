...
# $Date: 2023-02-05 10:40:17 -0500 (Sun, 05 Feb 2023) $
# $Author: vondreele $
# $Revision: 5494 $
# $URL: https://subversion.xray.aps.anl.gov/pyGSAS/trunk/GSASIIdataGUI.py $
# $Id: GSASIIdataGUI.py 5494 2023-02-05 15:40:17Z vondreele $
#=========- SVN repository information ###################
'''
...
#        self.ErrorAnal.Append(G2G.wxID_PWDCOPY,'Copy params','Copy of HKLF parameters') #unused
        ...
        G2G.Define_wxId('wxID_INSTPRMRESET','wxID_INSTCOPY','wxID_INSTFLAGCOPY','wxID_INSTLOAD',
            'wxID_INSTSAVE', 'wxID_INST1VAL', 'wxID_INSTCALIB', 'wxID_INSTSAVEALL','wxID_INSTSHOWMULT')
        ...
        self.InstEdit.Append(G2G.wxID_INSTSHOWMULT,'Show multiple','Show multiple histograms of same type as current')
        self.PostfillDataMenu()
